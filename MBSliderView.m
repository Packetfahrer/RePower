...
- (void) loadContent {
    ...
    if (!_label || !_slider) {
        ...
        sliderFrame.size.width -= 10; //each "edge" of the track is 2 pixels wide
...
- (UIImage *) thumbWithColor:(UIColor*)color {
    ...
    */
    ...
    UIGraphicsEndImageContext();
    UIImage *outputImage = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/RePower.bundle/chevron.png"];
