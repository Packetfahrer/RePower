...
- (void)animateFromIncomingCallStateToFaceTimeInCallStateWithCompletion:(CDUnknownBlockType)arg1;
- (void)animateFromIncomingCallStateToInCallStateWithCompletion:(CDUnknownBlockType)arg1;
- (void)animateOutRightMainButtonWithCompletion:(CDUnknownBlockType)arg1;
